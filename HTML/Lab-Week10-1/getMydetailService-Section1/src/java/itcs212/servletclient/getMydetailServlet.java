 ...
 * @author My Computer
 */
@WebServlet(name = "getMydetailServlet", urlPatterns = {"/getMydetailServlet"})
public class getMydetailServlet extends HttpServlet {

    @WebServiceRef(wsdlLocation = "C:\\data\\getMydetailService-Section1\\src\\conf\\xml-resources\\web-service-references\\HelloWorldWS\\wsdl\\localhost_8080\\HelloWorldWebApplication-Section1-2\\HelloWorldWS.wsdl")
